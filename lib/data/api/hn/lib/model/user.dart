...
class User {
  ...
  @override
  String toString() => 'User[id=$id, created=$created, karma=$karma, about=$about, submitted=$submitted]';
  ...
  static User? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return User(
        ...
        karma: json[r'karma'] == null
            ? null
            : num.parse(json[r'karma'].toString()),
        about: mapValueOfType<String>(json, r'about'),
        submitted: json[r'submitted'] is List
            ? (json[r'submitted'] as List).cast<int>()
            : const [],
      );
    }
    return null;
